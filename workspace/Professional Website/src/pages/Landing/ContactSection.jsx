  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 py-20">
      ...
      >
        ...
        <p className="text-amber-700 text-lg mb-12 max-w-2xl mx-auto">
          Interested in collaborating on music technology projects, discussing audio engineering,
          or exploring the intersection of AI and music? I'd love to hear from you.
        </p>
        ...
        <motion.div
          ...
          className="bg-amber-100 border-2 border-amber-300 rounded-2xl p-8 shadow-lg"
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <a
              ...
              className="flex items-center gap-2 px-5 py-3 bg-white border-2 border-amber-400
                rounded-lg hover:bg-amber-50 hover:border-amber-600 transition-all shadow-md"
            >
            ...
            >
              ...
              <span className="text-sm font-semibold text-amber-900">Google Scholar</span>
            </a>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-8 py-4 bg-amber-800 text-amber-50 font-semibold rounded-lg
              hover:bg-amber-900 transition-all shadow-lg"
          >
            Download Full CV
          </motion.a>
        </motion.div>
